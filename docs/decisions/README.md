...
| 0026 | [RSS summaries are scoped to the source being listed](0026-rss-source-summaries-are-source-scoped.md) | Proposed for #417 · source- and generation-scoped lateral aggregation first; nested `rss_full_content` public contract second; baseline rows are intentionally outside the five work counts |
